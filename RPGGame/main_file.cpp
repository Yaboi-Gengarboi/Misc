...
bool init()
{
    Characteristic(0, "Loves to eat.", 0);
    Characteristic(1, "Takes plenty of siestas.", 0);
    Characteristic(2, "Nods off a lot.", 0);
    Characteristic(3, "Scatters things often.", 0);
    Characteristic(4, "Likes to relax.", 0);
    Characteristic(5, "Proud of its power.", 1);
    Characteristic(6, "Likes to thrash about.", 1);
    Characteristic(7, "A little quick tempered.", 1);
    Characteristic(8, "Likes to fight.", 1);
    Characteristic(9, "Quick tempered.", 1);
    Characteristic(10, "Sturdy body.", 2);
    Characteristic(11, "Capable of taking hits.", 2);
    Characteristic(12, "Highly persistent.", 2);
    Characteristic(13, "Good endurance.", 2);
    Characteristic(14, "Good perseverance.", 2);
    Characteristic(15, "Highly curious.", 3);
    Characteristic(16, "Mischievous.", 3);
    Characteristic(17, "Thoroughly cunning.", 3);
    Characteristic(18, "Often lost in thought.", 3);
    Characteristic(19, "Very finicky.", 3);
    Characteristic(20, "Strong willed.", 4);
    Characteristic(21, "Somewhat vain.", 4);
    Characteristic(22, "Strongly defiant.", 4);
    Characteristic(23, "Hates to lose.", 4);
    Characteristic(24, "Somewhat stubborn.", 4);
    Characteristic(25, "Likes to run.", 5);
    Characteristic(26, "Alert to sounds.", 5);
    Characteristic(27, "Impetuous and silly.", 5);
    Characteristic(28, "Somewhat of a clown.", 5);
    Characteristic(29, "Quick to flee.", 5);
