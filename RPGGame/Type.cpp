...
const float type_matchup[18][18] =
{
    ...
    /* 6  : Bug      */ { 1,  .5,  .5,  .5,   1,   1,   1,  .5,  .5,  .5,   1,   2,   1,   2,   1,   1,   2,   2 },
    ...
    /* 10 : Water    */ { 1,   1,   1,   1,   2,   2,   1,   1,   1,   2,  .5,  .5,   1,   1,   1,  .5,   1,   1 },
    /* 11 : Grass    */ { 1,   1,  .5,   1,   2,   2,   1,   1,  .5,  .5,   2,  .5,   1,   1,   1,  .5,   1,   1 },
    ...
    /* 16 : Dark     */ { 1,  .5,   1,   1,   1,  .5,   1,   2,   1,   1,   1,   1,   1,   2,   1,   1,  .5,  .5 },
